...
#
# -name specyifukje jaka nazwe szukam (plik i w ogole)
# -podanie nazwy directory w ktorej szukam by przejsc test
#  domyslnie szuka po wszystki folderach w ktorych jest teraz domyslnie
