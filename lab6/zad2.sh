...
#                                   nazwa tablicy      |
#                                   napis       |      |
# funkcja split zajmuje kolejne argumenty |     |      |
# reszta to po prostu klasyczne ify wrzucone    |      |
# w przestrzen instrukcji awk             |     |      |
cat 'dodatkowe/etc-passwd' | awk  '{split($0, array, ":"); if(array[3] > 100 && array[7] == "/bin/bash" ) print array[1] }' 
