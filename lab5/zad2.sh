...
#
# -v - do exclude'a -e jak podaje wiecej niz jeden argument do exclude'a badz include'a
# cut -d -f1 - podziel i wybierz pojedyncze 
grep -v -e '/bin/nologin' -e '/bin/false'  'dodatkowe/etc-passwd' | cut -d ':' -f1